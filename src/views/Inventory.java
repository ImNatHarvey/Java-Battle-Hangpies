...
public class Inventory
{
	...
	private static void doRenameHangpie()
	{
		...
		if (inventory.isEmpty())
		{
			System.out.println("You have no Hangpies to rename.");
			return;
		}
		...
		System.out.println("Your Hangpie has been renamed to " + newName + "!");
	}
	...
	private static void doSellToShop()
	{
		...
		if (inventory.isEmpty())
		{
			System.out.println("You have no Hangpies to sell.");
			return;
		}
		...
		System.out.print("Are you sure you want to sell " + petToSell.getName() + " for " + sellPrice + "G? (yes/no): ");
		...
		if (choice.equalsIgnoreCase("yes"))
		{
			...
			System.out.println(petToSell.getName() + " has been sold.");
		...
		{
			System.out.println("Invalid Input. Sale cancelled.");
		}
	...
	private static void doListToMarketplace()
	{
		...
		if (inventory.isEmpty())
		{
			System.out.println("You have no Hangpies to list.");
			return;
		}
		...
		try
		{
			...
			if (sellingPrice <= 0)
			{
				System.out.println("Price must be positive. Listing cancelled.");
				return;
			}
		}
		...
		System.out.println(petToList.getName() + " is now listed on the Marketplace for " + sellingPrice + "G!");
	}
}
