...
public class GameConstants {
	...
	public static final String SUBTITLE_TEXT = "AN INTEGRATED GAMING AND MARKETPLACE SYSTEM"; // Kept for reference but
																								// not used in menu
	public static final String INSTRUCTION_TITLE = "HOW TO PLAY";
	// UPDATED: Content slightly reduced/adjusted for better fit with smaller font.
	public static final String INSTRUCTION_TEXT = "Type the letters on your keyboard to guess the word.\n\n"
			...
			+ "Win the World Boss (Stage 5) to advance world level and gain better rewards!";
	...
	// NEW: Smallest font size for detailed text in modals (18pt)
